...
budgetary estimates of the project. To visualize the proposed system,
...
of a quality, functional software product.

Its implementation is critical to the development of ``Echoes of Bathala
Online'' due to the high complexity of integrating two distinct systems:
a real-time Unity game engine and an asynchronous Blockchain network. By
facilitating continuous feedback, RAD allows for the early detection of
``race conditions'' between game logic and smart contracts, minimizing
the risk of costly redesigns. Additionally, the fast-moving development
cycles enable the project team to implement core functionalities to
deliver a playable software product within the academic timeframe.
